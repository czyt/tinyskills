...
Create a normal LPK app with these required pieces. The provider backend can be written in any language that can run commands, parse JSON, serve HTTP/WebSocket, and optionally allocate a PTY.
