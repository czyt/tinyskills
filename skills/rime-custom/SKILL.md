...
> → **详细配置和变体列表**：查阅 `references/schemes/rime-frost.md`
...
> → **详细变体列表和配置差异**：查阅 `references/schemes/rime-wanxiang.md`

**快速识别**：
| 常用变体 | Custom文件 | 特点 |
|---------|-----------|------|
| 标准版 | `wanxiang.custom.yaml` | 全拼/双拼通用 |
...
> → **详细变体列表**：查阅 `references/schemes/oh-my-rime.md`
