[Skip to content](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#start-of-content)

You signed in with another tab or window. [Reload](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md) to refresh your session.You signed out in another tab or window. [Reload](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md) to refresh your session.You switched accounts on another tab or window. [Reload](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md) to refresh your session.Dismiss alert

{{ message }}

[LEOYoon-Tsaw](https://github.com/LEOYoon-Tsaw)/ **[Rime\_collections](https://github.com/LEOYoon-Tsaw/Rime_collections)** Public

- [Notifications](https://github.com/login?return_to=%2FLEOYoon-Tsaw%2FRime_collections) You must be signed in to change notification settings
- [Fork\\
142](https://github.com/login?return_to=%2FLEOYoon-Tsaw%2FRime_collections)
- [Star\\
682](https://github.com/login?return_to=%2FLEOYoon-Tsaw%2FRime_collections)
...
[![LEOYoon-Tsaw](https://avatars.githubusercontent.com/u/4469383?v=4&size=40)](https://github.com/LEOYoon-Tsaw)[LEOYoon-Tsaw](https://github.com/LEOYoon-Tsaw/Rime_collections/commits?author=LEOYoon-Tsaw)

[Update Rime\_description.md](https://github.com/LEOYoon-Tsaw/Rime_collections/commit/9bda87def6724bb4fa8199a6a4ae7fa964695bef)

2 years agoMay 19, 2024

[9bda87d](https://github.com/LEOYoon-Tsaw/Rime_collections/commit/9bda87def6724bb4fa8199a6a4ae7fa964695bef) · 2 years agoMay 19, 2024

## History

[History](https://github.com/LEOYoon-Tsaw/Rime_collections/commits/master/Rime_description.md)

Open commit details

[View commit history for this file.](https://github.com/LEOYoon-Tsaw/Rime_collections/commits/master/Rime_description.md) History

809 lines (743 loc) · 34.3 KB
...
[Raw](https://github.com/LEOYoon-Tsaw/Rime_collections/raw/refs/heads/master/Rime_description.md)
...
[Permalink: Schema.yaml 詳解](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#schemayaml-%E8%A9%B3%E8%A7%A3)

* * *

## 開始之前

[Permalink: 開始之前](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E9%96%8B%E5%A7%8B%E4%B9%8B%E5%89%8D)
...
[Permalink: 描述檔](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E6%8F%8F%E8%BF%B0%E6%AA%94)
...
[Permalink: 示例](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E7%A4%BA%E4%BE%8B)
...
[Permalink: 開關](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E9%96%8B%E9%97%9C)
...
[Permalink: 示例](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E7%A4%BA%E4%BE%8B-1)
...
[Permalink: 引擎](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E5%BC%95%E6%93%8E)

- 以下 **加粗** 項爲可細配者， _斜體_ 者爲不常用者

引擎分四組：

### 一、`processors`

[Permalink: 一、processors](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E4%B8%80processors)

- 這批組件處理各類按鍵消息

01. `ascii_composer` 處理西文模式及中西文切
02. **`recognizer`** 與`matcher`搭配，處理符合特定規則的輸入碼，如網址、反查等`tags`
03. **`key_binder`** 在特定條件下將按鍵綁定到其他按鍵，如重定義逗號、句號爲候選翻頁、開關快捷鍵等
04. **`speller`** 拼寫處理器，接受字符按鍵，編輯輸入
05. **`punctuator`** 句讀處理器，將單個字符按鍵直接映射爲標點符號或文字
06. `selector` 選字處理器，處理數字選字鍵〔可以換成別的哦〕、上、下候選定位、換頁
07. `navigator` 處理輸入欄內的光標移動
08. `express_editor` 編輯器，處理空格、回車上屏、回退鍵
09. _`fluid_editor`_ 句式編輯器，用於以空格斷詞、回車上屏的【注音】、【語句流】等輸入方案，替換`express_editor`
...
[Permalink: 二、segmentors](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E4%BA%8Csegmentors)
...
[Permalink: 三、translators](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E4%B8%89translators)

- 這批組件翻譯特定類型的編碼段爲一組候選文字

01. `echo_translator` 沒有其他候選字時，回顯輸入碼〔輸入碼可以`Shift`+`Enter`上屛〕
02. `punct_translator` 配合`punct_segmentor`轉換標點符號
03. **`table_translator`** 碼表翻譯器，用於倉頡、五筆等基於碼表的輸入方案

\- 此項可加載多個實例，後接`@`+翻譯器名〔如：`cangjie`、`wubi`等〕
07. **`script_translator`** 腳本翻譯器，用於拼音、粵拼等基於音節表的輸入方案

\- 此項可加載多個實例，後接`@`+翻譯器名〔如：`pinyin`、`jyutping`等〕
11. _`reverse_lookup_translator`_ 反查翻譯器，用另一種編碼方案查碼
...
[Permalink: 四、filters](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E5%9B%9Bfilters)
...
4. **`simplifier`** 用字轉換
5. **`reverse_lookup_filter`** 反查濾鏡，以更靈活的方式反查，Rime1.0後替代 _`reverse_lookup_translator`_
...
[Permalink: 示例](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E7%A4%BA%E4%BE%8B-2)
...
[Permalink: 細項配置](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E7%B4%B0%E9%A0%85%E9%85%8D%E7%BD%AE)
...
[Permalink: 一、speller](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E4%B8%80speller)
...
[Permalink: 示例](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E7%A4%BA%E4%BE%8B-3)
...
[Permalink: 二、segmentor](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E4%BA%8Csegmentor)
...
[Permalink: 示例](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E7%A4%BA%E4%BE%8B-4)
...
[Permalink: 三、translator](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E4%B8%89translator)

- 每個方案有一個主`translator`，在引擎列表中不以`@`+翻譯器名定義，在細項配置時直接以`translator:`命名。以下加粗項爲可在主`translator`中定義之項，其它可在副〔以`@`+翻譯器名命名〕`translator`中定義

01. **`enable_charset_filter:`** 是否開啓字符集過濾〔僅`table_translator`有效。啓用`cjk_minifier`後可適用於`script_translator`〕
02. **`enable_encoder:`** 是否開啓自動造詞〔僅`table_translator`有效〕
03. **`encode_commit_history:`** 是否對已上屛詞自動成詞〔僅`table_translator`有效〕
04. **`max_phrase_length:`** 最大自動成詞詞長〔僅`table_translator`有效〕
05. **`enable_completion:`** 提前顯示尚未輸入完整碼的字〔僅`table_translator`有效〕
06. **`enable_correction:`** 啓用自動糾錯〔僅`script_translator`有效〕
07. **`sentence_over_completion:`** 在無全碼對應字而僅有逐鍵提示時也開啓智能組句〔僅`table_translator`有效〕
08. **`strict_spelling:`** 配合`speller`中的`fuzz`規則，僅以畧拼碼組詞〔僅`table_translator`有效〕
09. **`disable_user_dict_for_patterns:`** 禁止某些編碼錄入用戶詞典
...
[Permalink: 示例](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E7%A4%BA%E4%BE%8B-5)
...
[Permalink: 四、reverse_lookup_filter](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E5%9B%9Breverse_lookup_filter)
...
[Permalink: 示例](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E7%A4%BA%E4%BE%8B-6)
...
[Permalink: 五、simplifier](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E4%BA%94simplifier)
...
9. _`excluded_types:`_ 取消特定範圍〔一般爲 _`reverse_lookup_translator`_〕轉化用字

#### **示例**

[Permalink: 示例](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E7%A4%BA%E4%BE%8B-7)
...
[Permalink: 六、chord_composer](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E5%85%ADchord_composer)
...
[Permalink: 示例](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E7%A4%BA%E4%BE%8B-8)
...
[Permalink: 七、lua](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E4%B8%83lua)
...
[Permalink: 示例](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E7%A4%BA%E4%BE%8B-9)
...
[Permalink: 八、其它](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E5%85%AB%E5%85%B6%E5%AE%83)
...
[Permalink: 示例](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E7%A4%BA%E4%BE%8B-10)
...
[Permalink: 其它](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E5%85%B6%E5%AE%83)
...
[Permalink: 示例](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E7%A4%BA%E4%BE%8B-11)
...
[Permalink: Dict.yaml 詳解](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#dictyaml-%E8%A9%B3%E8%A7%A3)

* * *

## 開始之前

[Permalink: 開始之前](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E9%96%8B%E5%A7%8B%E4%B9%8B%E5%89%8D-1)
...
[Permalink: 描述檔](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E6%8F%8F%E8%BF%B0%E6%AA%94-1)
...
[Permalink: 示例](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E7%A4%BA%E4%BE%8B-12)
...
[Permalink: 配置](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E9%85%8D%E7%BD%AE)
...
[Permalink: 示例](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E7%A4%BA%E4%BE%8B-13)
...
[Permalink: 碼表](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E7%A2%BC%E8%A1%A8)

- 以`Tab`分隔各列，各列依`columns:`定義排列。

#### **示例**

[Permalink: 示例](https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md#%E7%A4%BA%E4%BE%8B-14)
